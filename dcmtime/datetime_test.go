...
func TestParseDatetimeErr(t *testing.T) {
	testCases := []struct {
		...
		{
			Name:     "ColonBeforeOffset",
			BadValue: "20210101:+0500",
		},
		{
			Name:     "ColonBeforeFraction",
			BadValue: "20210101010203:.123456",
		},
		{
			Name:     "ColonBeforeFractionAndOffset",
			BadValue: "20210101010203:.123456+0500",
		},
		{
			Name:     "ExtraDigit_TZ",
