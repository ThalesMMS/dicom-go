...
// DumpObject dumps a DICOM dataset object using the provided transfer syntax.
//
// This is useful for dumping DIMSE Identifier datasets received over the
// network (e.g., C-FIND responses), where there is no file meta header.
func (f *Formatter) DumpObject(obj *object.Object, syntax transfer.Syntax) error {
