...
var ErrMaxPixelDataBytesExceeded = errors.New("dicom: maximum Pixel Data size exceeded")
var ErrMaxDeformableVectorGridBytesExceeded = errors.New("dicom: maximum deformable Vector Grid Data size exceeded")
